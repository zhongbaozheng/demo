 ...
 * this is a view for indicator's shape
 */
public class ShapeIndicatorView extends View  implements TabLayout.OnTabSelectedListener, ViewPager.OnPageChangeListener{
    ...
    private void    initViews(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes){
        ...
        mShapeHorizontalSpace = array.getInteger(R.styleable.ShapeIndicatorView_horizontalSpace, 10);
        mShapeColor = array.getColor(R.styleable.ShapeIndicatorView_fullColor, Color.GRAY);
        int radius = array.getInteger(R.styleable.ShapeIndicatorView_radius, 5);
        array.recycle();
